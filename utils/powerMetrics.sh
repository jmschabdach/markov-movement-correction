...
#Quick script to calculate displacement and 
# voxel intensity changes per Power et al. (2012?)
# Usage:
...
# want to use the metric --fd for frame displacement (follows Power et al.; requires motion correction)
# want to use the metric --dvars (RMS intensity difference of volume N to volume N+1)
